...
/**
 * The TanayKotian class can be used as a model for your own class that represents you and your seating location in AP CSA
 * 
 * @author Mr. Kaehms
...
public class TanayKotian extends Student implements SpecialInterestOrHobby, CSALearnedSoFar, ListOfToDo
{
    ...
    /**
     * Constructor for the TanayKotian class.
     ...
     * 
     */
    public TanayKotian(String f, String l, int r, int s) {
        firstName=f;
        lastName=l;
        mySeatX=r;
        mySeatY=s;
    ...
    public TanayKotian() {
     ...
     /**
     * Act - do whatever the TanayKotian actor wants to do. This method is called whenever
    ...
    /**
     * This is a local method specific to the TanayKotian class used to animate the character once the image is clicked on.
