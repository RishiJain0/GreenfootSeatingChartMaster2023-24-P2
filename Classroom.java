...
public class Classroom extends World {
  ...
  private void prepare() {
    createDeskLayout();
    // Each student needs to create their specific instance following the
    // KilgoreTrout example.
    // Your current seatX and seatY can be found by right clicking on the
    // corresponding seat in the Classrom.
    ...
    MeetingButton button7 = new MeetingButton(new Student[] {rocketuzarraga, connorTK});
